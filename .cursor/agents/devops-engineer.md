...
---
<!-- AUTO-GENERATED from .claude/agents/dev/devops-engineer.md by scripts/sync-tool-configs.py. DO NOT EDIT — change the source and re-run. -->
> **Source of truth:** `.claude/agents/dev/devops-engineer.md` · **Read-only role:** no · **Source tools:** Read, Edit, Write, Bash, PowerShell, Glob, Grep
