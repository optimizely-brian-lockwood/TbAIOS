...
---
<!-- AUTO-GENERATED from .claude/agents/dev/ux-designer.md by scripts/sync-tool-configs.py. DO NOT EDIT — change the source and re-run. -->
> **Source of truth:** `.claude/agents/dev/ux-designer.md` · **Read-only role:** no · **Source tools:** Read, Glob, Grep, WebSearch, WebFetch, Write
