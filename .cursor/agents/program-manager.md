...
---
<!-- AUTO-GENERATED from .claude/agents/office/program-manager.md by scripts/sync-tool-configs.py. DO NOT EDIT — change the source and re-run. -->
> **Source of truth:** `.claude/agents/office/program-manager.md` · **Read-only role:** no · **Source tools:** Read, Write, Edit, Glob, Grep
