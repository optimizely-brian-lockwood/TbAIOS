...
---
<!-- AUTO-GENERATED from .claude/agents/dev/qa-engineer.md by scripts/sync-tool-configs.py. DO NOT EDIT — change the source and re-run. -->
> **Source of truth:** `.claude/agents/dev/qa-engineer.md` · **Read-only role:** no · **Source tools:** Read, Bash, PowerShell, Glob, Grep, Write
