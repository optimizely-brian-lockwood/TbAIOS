...
---
<!-- AUTO-GENERATED from .claude/agents/dev/engineering-manager.md by scripts/sync-tool-configs.py. DO NOT EDIT — change the source and re-run. -->
> **Source of truth:** `.claude/agents/dev/engineering-manager.md` · **Read-only role:** yes · **Source tools:** Read, Glob, Grep, Agent, TaskCreate, TaskList, TaskGet, TaskUpdate
