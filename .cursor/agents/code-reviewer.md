...
---
<!-- AUTO-GENERATED from .claude/agents/dev/code-reviewer.md by scripts/sync-tool-configs.py. DO NOT EDIT — change the source and re-run. -->
> **Source of truth:** `.claude/agents/dev/code-reviewer.md` · **Read-only role:** yes · **Source tools:** Read, Glob, Grep, Bash, PowerShell
