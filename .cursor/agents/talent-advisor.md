...
---
<!-- AUTO-GENERATED from .claude/agents/office/talent-advisor.md by scripts/sync-tool-configs.py. DO NOT EDIT — change the source and re-run. -->
> **Source of truth:** `.claude/agents/office/talent-advisor.md` · **Read-only role:** no · **Source tools:** Read, Glob, Grep, Write
