...
---
<!-- AUTO-GENERATED from .claude/agents/office/ai-solution-architect.md by scripts/sync-tool-configs.py. DO NOT EDIT — change the source and re-run. -->
> **Source of truth:** `.claude/agents/office/ai-solution-architect.md` · **Read-only role:** no · **Source tools:** Read, Glob, Grep, WebSearch, WebFetch, Write
