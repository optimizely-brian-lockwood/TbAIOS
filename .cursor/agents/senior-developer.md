...
---
<!-- AUTO-GENERATED from .claude/agents/dev/senior-developer.md by scripts/sync-tool-configs.py. DO NOT EDIT — change the source and re-run. -->
> **Source of truth:** `.claude/agents/dev/senior-developer.md` · **Read-only role:** no · **Source tools:** Read, Edit, Write, Bash, PowerShell, Glob, Grep
