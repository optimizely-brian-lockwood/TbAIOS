...
---
<!-- AUTO-GENERATED from .claude/agents/office/engineering-liaison.md by scripts/sync-tool-configs.py. DO NOT EDIT — change the source and re-run. -->
> **Source of truth:** `.claude/agents/office/engineering-liaison.md` · **Read-only role:** no · **Source tools:** Read, Glob, Grep, Agent, Write
